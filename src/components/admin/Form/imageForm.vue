                ...
                <div>
                    ...
                    <div class="mt-1 flex rounded-lg">
                      <span class="inline-flex items-center rounded-l-lg border border-r-0 border-gray-300 bg-gray-50 px-3 text-sm text-gray-500">
                          <PhotoIcon class="w-4 h-5"/>
                      </span>
                      <input type="text" id="name" placeholder="Nhập tiêu đề cho hình..." v-model="form.name" autocomplete="name"
...
import { useImageStore } from "../../../stores/image";
    ...
    methods: {
        ...
        ...mapActions(useImageStore, ["postImage"]),
    },
