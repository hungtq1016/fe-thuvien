<template>
    <section>
        <div class="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32 min-h-[600px]">
            <img src="https://images.unsplash.com/photo-1521737604893-d14cc237f11d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&crop=focalpoint&fp-y=.8&w=2830&h=1500&q=80&blend=111827&sat=-100&exp=15&blend-mode=multiply" alt=""
            ...
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
              ...
              <div class="mx-auto mt-10 max-w-2xl lg:mx-0 lg:max-w-none" v-if="dataBooks !== undefined">
                <div class="grid grid-cols-1 gap-y-6 gap-x-8 text-base font-semibold leading-7 text-white sm:grid-cols-2 md:flex lg:gap-x-10">
                  ...
                  <router-link :to="{name:'CategoryList'}">Khám phá đề tài khác <span aria-hidden="true">&rarr;</span></router-link>
                </div>
...
import { useBooksMenu } from '../../../stores/books';
    ...
    export default {
        data(){
            return{
                links:[
                    {name:'Xem tất cả',query:'all'},
                    {name:'Nổi bật',query:'hot'},
                    {name:'Mới nhất',query:'new'},
                ],
                stats:[
                    {name:'Số lượng sách',value:122},
                    {name:'Tổng sách đã mượn',value:89},
