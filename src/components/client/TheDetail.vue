            ...
            >
                <section aria-labelledby="options-heading">
                    ...
                    <div class="flex pt-6 pb-4 gap-x-4">
                        ...
                        <!-- <TheFavorite :book="book" :key="book"/> -->
                    </div>
                </section>
            </div>
        </div>
...
import TheFavorite from './Book/TheFavorite.vue';

export default {
    components: { CheckIcon, Disclosure, DisclosureButton, DisclosurePanel, ChevronUpIcon, TheSection, TheComment, TheImage, TheFavorite },
    data() {
        return {
            openComment:false,
            labels:[
